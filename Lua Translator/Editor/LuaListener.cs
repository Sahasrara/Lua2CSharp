...
public interface ILuaListener : IParseTreeListener
{
    ...
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void EnterVar_([NotNull] LuaParser.Var_Context context);
    /// <summary>
    /// Exit a parse tree produced by <see cref="LuaParser.var_"/>.
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void ExitVar_([NotNull] LuaParser.Var_Context context);
    /// <summary>
    ...
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void EnterNil([NotNull] LuaParser.NilContext context);
    /// <summary>
    /// Exit a parse tree produced by <see cref="LuaParser.nil"/>.
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void ExitNil([NotNull] LuaParser.NilContext context);
    /// <summary>
    /// Enter a parse tree produced by <see cref="LuaParser.boolean"/>.
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void EnterBoolean([NotNull] LuaParser.BooleanContext context);
    /// <summary>
    /// Exit a parse tree produced by <see cref="LuaParser.boolean"/>.
    /// </summary>
    /// <param name="context">The parse tree.</param>
    void ExitBoolean([NotNull] LuaParser.BooleanContext context);
}
