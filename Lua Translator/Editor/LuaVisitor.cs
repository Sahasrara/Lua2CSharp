...
public interface ILuaVisitor<Result> : IParseTreeVisitor<Result>
{
    ...
    /// <param name="context">The parse tree.</param>
    /// <return>The visitor result.</return>
    Result VisitVar_([NotNull] LuaParser.Var_Context context);
    /// <summary>
    ...
    /// <param name="context">The parse tree.</param>
    /// <return>The visitor result.</return>
    Result VisitNil([NotNull] LuaParser.NilContext context);
    /// <summary>
    /// Visit a parse tree produced by <see cref="LuaParser.boolean"/>.
    /// </summary>
    /// <param name="context">The parse tree.</param>
    /// <return>The visitor result.</return>
    Result VisitBoolean([NotNull] LuaParser.BooleanContext context);
}
